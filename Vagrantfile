...
$configureBox = <<-SCRIPT
    ...
    sudo apt-get update && sudo apt-get install -y docker-ce=$(apt-cache madison docker-ce | grep 18.09 | head -1 | awk '{print $3}')
...
$configureMaster = <<-SCRIPT
    ...
    sudo kubeadm init --apiserver-advertise-address=192.168.205.10 --apiserver-cert-extra-sans=192.168.205.10  --node-name=k8s-head --pod-network-cidr=172.16.0.0/16
